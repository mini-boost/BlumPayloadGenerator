...
export function A(e, n) {
  // console.log({
  //   e,
  //   n,
  //   x: (e = e >>> 0),
  //   xx: E.decode(S().subarray(e, e + n)),
  // });
...
export async function R(e) {
  ...
  //   ? ({ module_or_path: e } = e)
  //   : null,
  //   typeof e > "u" && (e = new URL("" + new URL("game_wasm_bg-BnV071fP.wasm")));
  const n = $();
  // (typeof e == "string" ||
